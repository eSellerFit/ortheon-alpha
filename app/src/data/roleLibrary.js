...
export const roleLibrary = [
  ...
  // ============================================================
  // TECHNOLOGY EXECUTIVE (TE) — 10 directions
  // ============================================================

  {
    ...
    metaDirection: "Cloud, Infrastructure & DevOps",
    context: "Enterprise",
    contextCode: "E",
    directionLabel: "Cloud / Infrastructure / DevOps Leadership — Enterprise",
    aiDurabilityRating: "D3",
    aiExposureSource: "Anthropic Economic Index 2026",
    requiredCompetencies: [9, 12, 18, 4],
    preferredCompetencies: [10, 8, 23, 7],
    dominantAnchors: [
      { anchorId: "technical", idealMin: 7, idealMax: 10 },
      { anchorId: "challenge", idealMin: 5, idealMax: 10 },
    ],
    ...
    financialRiskLevel: "low",
    bridgeDirections: ["TE-5-E", "TE-1-E"],
    longerPathOptions: ["TE-3-E"],
    stretchabilityRequired: "medium",
    transitionPathway: "direct",
    d4EvolutionPath:
      "AI-augmented infrastructure leader using AI for observability, capacity planning, and infrastructure design while focusing on cloud operations, platform resilience, and modernization execution",
  },

  {
    directionId: "TE-8-E",
    version: "v2.2",
    onetCodes: ["11-3021.00", "15-1211.00"],
    onetTitles: ["Computer and Information Systems Managers", "Computer Systems Analysts"],
    category: "Technology Executive",
    metaDirection: "Business Systems & Enterprise Applications",
    context: "Enterprise",
    contextCode: "E",
    directionLabel: "Business Systems / Enterprise Applications Leadership — Enterprise",
    aiDurabilityRating: "D3",
    aiExposureSource: "Anthropic Economic Index 2026",
    requiredCompetencies: [9, 12, 6, 4],
    preferredCompetencies: [8, 10, 1, 18],
    dominantAnchors: [
      { anchorId: "technical", idealMin: 6, idealMax: 10 },
      { anchorId: "management", idealMin: 5, idealMax: 10 },
    ],
    ...
    financialRiskLevel: "low",
    bridgeDirections: ["TE-5-E", "TE-3-E"],
    longerPathOptions: ["TE-1-E"],
    stretchabilityRequired: "medium",
    transitionPathway: "direct",
    d4EvolutionPath:
      "AI-augmented business systems leader using AI for requirements analysis, workflow diagnostics, application design, and support while focusing on enterprise application ownership and implementation judgment",
  },
...

  {
    directionId: "TE-9-E",
    version: "v2.2",
    onetCodes: ["13-1111.00", "11-3021.00"],
    onetTitles: ["Management Analysts", "Computer and Information Systems Managers"],
    category: "Technology Executive",
    metaDirection: "Business Process Automation",
    context: "Enterprise",
    contextCode: "E",
    directionLabel: "Business Process Automation Leadership — Enterprise",
    aiDurabilityRating: "D3",
    aiExposureSource: "Anthropic Economic Index 2026",
    requiredCompetencies: [6, 9, 12, 4],
    preferredCompetencies: [5, 20, 8, 1],
    dominantAnchors: [
      { anchorId: "technical", idealMin: 5, idealMax: 10 },
      { anchorId: "impact", idealMin: 5, idealMax: 10 },
    ],
    ...
    financialRiskLevel: "low",
    bridgeDirections: ["TE-3-E", "CM-8-IF"],
    longerPathOptions: ["TE-10-E"],
    stretchabilityRequired: "medium",
    transitionPathway: "direct",
    d4EvolutionPath:
      "AI-augmented automation leader using AI for process discovery, workflow design, and implementation support while focusing on business process redesign and adoption",
  },

  {
    ...
    onetTitles: ["Computer and Information Systems Managers", "Management Analysts"],
    category: "Technology Executive",
    metaDirection: "Enterprise AI Enablement",
    context: "Enterprise",
    contextCode: "E",
    directionLabel: "Enterprise AI Enablement / Adoption Leadership — Enterprise",
    aiDurabilityRating: "D4",
    aiExposureSource: "Anthropic Economic Index 2026",
    requiredCompetencies: [20, 5, 6, 4],
    preferredCompetencies: [10, 8, 21, 1],
    dominantAnchors: [
      { anchorId: "technical", idealMin: 6, idealMax: 10 },
      { anchorId: "impact", idealMin: 6, idealMax: 10 },
    ],
    ...
    financialRiskLevel: "low",
    bridgeDirections: ["TE-3-E", "TE-9-E", "CM-5-IF"],
    longerPathOptions: [],
    stretchabilityRequired: "medium",
    transitionPathway: "direct",
    d4EvolutionPath:
      "This IS a D4 enablement path — leading enterprise AI adoption, use-case design and rollout, change management, and operating-model implementation without defaulting to AI product building or governance ownership",
  },
